...
exports.RESPONSE_CONTRACT_SCHEMAS = {
    ...
    TaskOpportunitySummary: { type: 'object', required: ['id', 'title', 'companyId', 'ownerId', 'priority', 'archivedAt'], properties: { id: uuid, title: { type: 'string' }, companyId: uuid, ownerId: nullableUuid, priority: enumOf(client_1.Priority), archivedAt: nullableDateTime } },
