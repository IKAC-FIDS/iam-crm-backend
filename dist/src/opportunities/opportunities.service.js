...
let OpportunitiesService = class OpportunitiesService {
    ...
    async create(dto, user) {
        ...
        const opportunity = await this.prisma.opportunity.create({
            data: {
                ...
                source: dto.source,
                wonAt: stage === client_1.PipelineStage.DONE ? new Date() : undefined,
    ...
    async changeStage(id, dto, user) {
        ...
        await this.pipelineConfig.assertTransitionAllowed(current.stage, dto.stage, user.role);
        const now = new Date();
        const [updated] = await this.prisma.$transaction([
            this.prisma.opportunity.update({
                ...
                data: {
                    stage: dto.stage,
                    wonAt: dto.stage === client_1.PipelineStage.DONE ? now : null,
