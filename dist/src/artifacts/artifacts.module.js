...
exports.ArtifactsModule = ArtifactsModule = __decorate([
    (0, common_1.Module)({ imports: [attachments_module_1.AttachmentsModule], controllers: [artifacts_controller_1.ArtifactsController], providers: [artifacts_service_1.ArtifactsService], exports: [artifacts_service_1.ArtifactsService] })
], ArtifactsModule);
