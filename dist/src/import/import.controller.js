...
let ImportController = class ImportController {
    ...
    async importSAMList(file, user) {
        if (!file) {
            throw new common_1.BadRequestException('فایل آپلود نشده است');
        }
        ...
        if (!allowedMimeTypes.includes(file.mimetype)) {
            throw new common_1.BadRequestException('فرمت فایل باید Excel باشد (.xlsx یا .xls)');
        }
...
], ImportController.prototype, "importSAMList", null);
