...
exports.meetingAssigneeEmail = meetingAssigneeEmail;
const modeLabels = {
    IN_PERSON: 'حضوری',
    ONLINE: 'آنلاین',
    HYBRID: 'ترکیبی',
};
function meetingAssigneeEmail(input) {
    ...
    const rows = fields
        ...
        .join('');
    const optionalSection = (title, value) => value?.trim()
...
//# sourceMappingURL=meeting-email.template.js.map