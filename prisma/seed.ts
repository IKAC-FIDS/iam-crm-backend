...
async function main() {
  ...
  const permissions = [
    ...
    { action: 'opportunity:view', description: 'View opportunities' },
    { action: 'opportunity:create', description: 'Create opportunities' },
    { action: 'opportunity:update', description: 'Update opportunities' },
    { action: 'opportunity:change-stage', description: 'Change opportunity stage' },
    { action: 'opportunity:change-owner', description: 'Change opportunity owner' },
    { action: 'opportunity:archive', description: 'Archive opportunities' },
    { action: 'opportunity:restore', description: 'Restore opportunities' },
